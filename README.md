...
> **Attribution.** This repository was originally cloned from
> [cisnlp/Glot500](https://github.com/cisnlp/Glot500) and has since diverged
> substantially in evaluation tooling, dependency pinning, and dataset loaders.
> Original model, paper, and data credits belong to the cisnlp authors.
> The original [LICENSE](LICENSE) is preserved verbatim. This repository is
> maintained independently and is not intended for upstream contribution.
